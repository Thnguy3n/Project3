		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" method="post">
                    <input class="text" type="text" id="fullname" placeholder="Full name" required="">
                    <input class="text spacee" type="email" id="email" placeholder="Email" required="">
                    <input class="text spacee" type="text" id="phone" placeholder="Phone number" required="">
                    <input class="text spacee" type="text" id="username" placeholder="Username" required="">
					<input class="text spacee" type="password" id="password" placeholder="Password" required="">
