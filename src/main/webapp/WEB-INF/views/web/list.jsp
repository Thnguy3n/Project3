    ...
    <div class="product mt-5">
                    ...
                    <a href='<c:url value="chi-tiet-${item.id}"/> '>
                        ...
                        <div class="product1 vip">
                            <div class="product1 position-static" >
                                <img  src="/repository${item.image}" alt="" style="width:100%; height: 15.525rem;">
                            </div>
                            ...
                            <div class="product1-footer">
                                ...
                                <button class="product1-footer-detail"><a href='<c:url value="chi-tiet"/> ' style="color:#fff">Xem
                                    chi
                                    tiết</a></button>
                            </div>
                        </div>
        ...
        <footer class="footer">
            ...
            <div class="bottom-footer-2">
                <div class="text-center desc-bottom-footer-2">@ Bản quyền thuộc về Nguyen Team |
