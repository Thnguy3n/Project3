...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content center-container">
                        ...
                        <div class="col-xs-12">
                            <form action="" class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <form:checkboxes items="${typeCodes}" path="typeCode" cssStyle="margin:10px"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="col-sm-3 no-padding-right" style="max-width: 100%" type="file" id="uploadImage"/>
                                    <div class="col-sm-9">
                                        ...
                                        <c:if test="${empty buildingEdit.image}">
                                            <img src="/admin/image/defaul.jpg" id="viewImage" width="300px"
                                                 height="300px">
                                        </c:if>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <c:if test="${not empty buildingEdit.id}">
                                            <button type="button" class="btn btn-primary" id="btnAddOrUpdateBuildingss">
                                                Cập nhật tòa nhà
                                            </button>
  ...
  <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js"
    ...
    var imageBase64 = '';
    var imageName = '';
    $('#btnAddOrUpdateBuildingss').click(function () {
        var data = {};
        var typeCode = [];
